...
export default function Skills() {
  ...
  return (
    <div     id="skills" className=" bg-gradient-to-b to-white from-sky-200 dark:to-slate-800 dark:from-slate-900 flex flex-col py-4 tablet:py-14">
      <div className="p-3  main-container flex flex-col gap-8 tablet:gap-10 laptop:gap-16 justify-center items-center">
        ...
        <div className=" flex flex-wrap gap-6 tablet:gap-7 justify-center items-center ">
          <svg
            className="h-10 tablet:h-14 fill-slate-700 dark:fill-white "
            viewBox="0 0 512 512"
            xmlSpace="preserve"
          ...
          >
            <path
              d="m71.197 46 33.604 377.479L255.474 466l151.725-42.521L440.803 46H71.197zM367.82 169.11H190.905l3.929 47.519h169.058l-13.137 142.792-94.236 25.99v.268h-1.045l-95.029-26.258-5.775-72.975h45.939l3.41 36.754 51.455 13.914 51.707-13.914 5.782-59.846H152.312l-12.335-140.176h232.047l-4.204 45.932z"
          ...
          <svg
            ...
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 429.98 492.74"
          >
            <defs></defs>
            <path
              className="cls-1"
              d="M0,0,39.15,443.46,215,492.74l175.77-49.25L430,0ZM346.25,145l-4.95,55.7-14.93,167L215,398.62l-.09,0L103.55,367.74l-7.76-87.35h54.54l4,45.3,60.54,16.39,0,0,60.62-16.38,8.27-75.48-190.67.54-5.4-51.63,200.63-2.38,4.07-55.23-210.08.59-3.53-51.4H351.1Z"
            />
          </svg>
          <svg
            className="h-10 tablet:h-14 fill-slate-700 dark:fill-white "
              ...
              <TimelineItem>
                ...
                <TimelineContent>
                  <p
                    ...
                    className="text-small-heading font-main text-slate-700 dark:text-slate-100 "
                  >
                    Developing back-end website applications and creating
              ...
              <TimelineItem>
                ...
                <TimelineContent>
                  <p
                    ...
                    className="text-small-heading font-main text-slate-700 dark:text-slate-100 "
                  >
                    Ensuring responsiveness of applications and working
