...
var Popper = React5.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime5.jsx)(Portal, {
    disablePortal,
    container,
...
var _excluded3 = ["badgeContent", "children", "invisible", "max", "slotProps", "slots", "showZero"];
...
var _excluded4 = ["action", "children", "disabled", "focusableWhenDisabled", "onFocusVisible", "slotProps", "slots"];
...
true ? Button.propTypes = {
   ...
   * @default false
   */
  focusableWhenDisabled: import_prop_types6.default.bool,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  to: import_prop_types6.default.string
} : void 0;
...
var _excluded5 = ["defaultValue", "children", "disabled", "error", "onChange", "required", "slotProps", "slots", "value"];
...
function useForcedRerendering() {
  const [, setState] = React25.useState({});
...
function useListItem(parameters) {
  ...
  const createHandleClick = React27.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React27.useCallback((other) => (event) => {
...
var NumberInput = React38.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime18.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime17.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime17.jsx)(IncrementButton, _extends({}, incrementButtonProps)), (0, import_jsx_runtime17.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YOHXIDOT.js.map
